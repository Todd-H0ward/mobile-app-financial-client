...
const SKIN_PREVIEWS: Record<RobotDogSkin, number> = {
  factory: require('../../../../assets/pet/robot-dog/previews/factory.jpg'),
  arctic: require('../../../../assets/pet/robot-dog/previews/arctic.jpg'),
  carbon: require('../../../../assets/pet/robot-dog/previews/carbon.jpg'),
  desert: require('../../../../assets/pet/robot-dog/previews/desert.jpg'),
  forest: require('../../../../assets/pet/robot-dog/previews/forest.jpg'),
  rescue: require('../../../../assets/pet/robot-dog/previews/rescue.jpg'),
  rust: require('../../../../assets/pet/robot-dog/previews/rust.jpg'),
};
...
export const PetCard = ({
  ...
  return (
    <Card tone="surfaceSoft">
      <Card.Title>{t('settings.pet')}</Card.Title>
      <Card.Content style={styles.content}>
        <ListRow
          title={t('settings.petSkin')}
